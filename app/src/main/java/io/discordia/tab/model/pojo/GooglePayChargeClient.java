...
import io.discordia.tab.viewmodel.CheckoutActivity;
...
public class GooglePayChargeClient {
  ...
  public void charge(String googlePayToken){
    ...
    requestNonceCall = (Call<GooglePayNonceResult>) GooglePay.requestGooglePayNonce(googlePayToken);
    reuqestNonceCall.enqueue((result) -> onNonceRequestResult(googlePayToken, result));
  }
